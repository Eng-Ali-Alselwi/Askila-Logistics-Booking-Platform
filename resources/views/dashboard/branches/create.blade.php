    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">{{ t('Add New Branch') }}</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">{{ t('Dashboard') }}</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.branches.index') }}">{{ t('Branches') }}</a></li>
                        <li class="breadcrumb-item active">{{ t('Add New Branch') }}</li>
                    </ol>
                </div>
            </div>
        </div>
