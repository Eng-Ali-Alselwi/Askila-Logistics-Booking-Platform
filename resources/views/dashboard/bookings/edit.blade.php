...
@section('content')
    @include('dashboard.layout.shared/page-title', ['subtitle' => t('Edit Booking'), 'title' => 'Dashboard'])
                ...
                <div class="border-b border-gray-200 dark:border-gray-700 pb-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="number_of_passengers" name="number_of_passengers" value="{{ old('number_of_passengers', $booking->number_of_passengers) }}" min="1" max="9" required
