        ...
        <div class="flex flex-wrap justify-between items-center">
            ...
            <div class="flex items-center lg:order-2 space-x-1.5">
                <button type="button"
                    ...
                    <x-icons icon="plus" class="mr-1 -ml-1" />
                    New Widget</button>
              ...
              <x-theme-switcher/>
                ...
                <button type="button" data-dropdown-toggle="notification-dropdown"
                    class=" p-2 me-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600">
                ...
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                    ...
                    <div class="grid grid-cols-3 gap-4 p-4">
                        <x-dashboard.navbar.apptile href="#" icon="sales" label="Sales" />
                        <x-dashboard.navbar.apptile href="#" icon="users" label="Users" />
                        <x-dashboard.navbar.apptile href="#" icon="inbox" label="Inbox" />
                        <x-dashboard.navbar.apptile href="#" icon="profile" label="Profile" />
                        <x-dashboard.navbar.apptile href="#" icon="settings" label="Settings" />
                        <x-dashboard.navbar.apptile href="#" icon="product" label="Products" />
                        <x-dashboard.navbar.apptile href="#" icon="pricing" label="Pricing" />
                        <x-dashboard.navbar.apptile href="#" icon="billing" label="Billing" />
                        <x-dashboard.navbar.apptile href="#" icon="logout" label="Logout" />
